    ...
    <div className="modal-bg" id="modal" role="dialog" aria-modal="true" aria-labelledby="modal-title">
      <div className="modal">
        ...
        <div className="modal-field">
          ...
          <input id="modal-player" className="notranslate" type="text" readOnly translate="no" />
        </div>
        <div className="modal-field">
          <label htmlFor="modal-reason" data-i18n="modal.reason">Reason</label>
          <input id="modal-reason" type="text" placeholder="Enter reason&#8230;" data-i18n-placeholder="modal.reasonPlaceholder" />
        </div>
